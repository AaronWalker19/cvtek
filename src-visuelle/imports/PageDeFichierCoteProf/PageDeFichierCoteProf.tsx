import svgPaths from "./svg-uwrwsgjoxh";

function Frame() {
  return (
    <div className="bg-[#4b575f] h-full relative shrink-0">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-between px-[30px] py-[20px] relative size-full">
          <div className="content-stretch flex flex-col gap-[15px] items-start relative shrink-0 w-[176px]">
            ...
            <div className="h-[43px] relative shrink-0 w-full" data-name="Accueil">
              <div className="flex flex-row items-center justify-center size-full">
                <div className="content-stretch flex items-center justify-center p-[2px] relative size-full" />
              </div>
            </div>
...
function Frame1() {
  return (
    <div className="content-stretch flex items-center justify-between py-[10px] relative shrink-0 w-[1112px]">
      <div aria-hidden="true" className="absolute border-[#4b575f] border-b-3 border-solid inset-0 pointer-events-none" />
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[#4b575f] text-[32px] whitespace-nowrap">Cv numéro ....</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#4b575f] text-[24px] whitespace-nowrap">M.valin</p>
    </div>
  );
}
    ...
    <div className="relative shrink-0 w-full">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[10px] relative size-full">
          <p className="flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[normal] min-w-px not-italic relative text-[#4b575f] text-[16px] text-right">M. Valin</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="absolute inset-[12.5%_12.5%_0.78%_12.5%]" data-name="Group">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 26.25 30.3537">
        <g id="Group">
          <g id="Vector" />
          <path clipRule="evenodd" d={svgPaths.p25feb300} fill="var(--fill-0, #36302A)" fillRule="evenodd" id="Vector_2" />
        </g>
      </svg>
    </div>
  );
        ...
        <div className="content-stretch flex flex-col gap-[50px] items-center p-[40px] relative size-full">
          ...
          <div className="content-stretch flex flex-[1_0_0] gap-[20px] items-start min-h-px relative w-full">
            <div className="bg-[#d9d9d9] content-stretch flex flex-col gap-[10px] h-[901px] items-center justify-center pb-[412px] pl-[270px] pr-[269px] pt-[450px] relative shrink-0 w-[701px]">
              ...
              <div className="absolute bg-[#4b575f] left-[633px] rounded-[40px] size-[54px] top-[14px]" data-name="material-symbols:download-rounded">
                <div className="absolute inset-[16.67%]" data-name="Vector">
                  <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 36 36">
                    <path d={svgPaths.p213ae500} fill="var(--fill-0, white)" id="Vector" />
                  </svg>
                </div>
              </div>
            </div>
                                ...
                                <div className="relative shrink-0 size-[24px]" data-name="solar:pen-bold">
                                  <div className="absolute inset-[8.33%]" data-name="Vector">
                                    <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20.0007 20.0007">
                                      <path d={svgPaths.p28ddbb00} fill="var(--fill-0, #F7F7F7)" id="Vector" />
                                    </svg>
                                  </div>
                                </div>
                                <div className="relative shrink-0 size-[24px]" data-name="mdi:trash">
                                  <div className="absolute inset-[12.5%_20.83%]" data-name="Vector">
                                    <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 18">
                                      <path d={svgPaths.p2eb23700} fill="var(--fill-0, #F7F7F7)" id="Vector" />
                                    </svg>
                                  </div>
                                </div>
                              </div>
